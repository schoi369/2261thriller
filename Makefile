...
SOURCES            = main.c myLib.c game.c bgGame.c bgGame2.c bgLose.c bgPause.c bgStart.c bgWin.c bgInst.c spritesheet.c text.c sound.c thriller8bit.c startBGM.c loseBGM.c zombiedeath.c bgStart1.c bgStart2.c MJWin.c cheatBGM.c
