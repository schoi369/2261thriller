...
# 37 "main.c" 2
# 1 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 1 3
# 17 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 3
# 1 "c:\\devkitarm\\lib\\gcc\\arm-none-eabi\\7.1.0\\include\\stddef.h" 1 3 4
# 18 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 2 3
...
# 102 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 3
char *_strdup_r (struct _reent *, const char *);



char *_strndup_r (struct _reent *, const char *, size_t);
# 133 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 3
char * _strerror_r (struct _reent *, int, int, int *);
# 155 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 3
char *strsignal (int __signo);
# 192 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 3
# 1 "c:\\devkitarm\\arm-none-eabi\\include\\sys\\string.h" 1 3
# 193 "c:\\devkitarm\\arm-none-eabi\\include\\string.h" 2 3
...
# 1 "bgStart1.h" 1
# 22 "bgStart1.h"
extern const unsigned short bgStart1Tiles[2544];
...
# 1 "bgStart2.h" 1
# 22 "bgStart2.h"
extern const unsigned short bgStart2Tiles[2608];
...
# 1 "bgGame2.h" 1
# 22 "bgGame2.h"
extern const unsigned short bgGame2Tiles[7520];


extern const unsigned short bgGame2Map[2048];


extern const unsigned short bgGame2Pal[256];
# 53 "main.c" 2
# 1 "bgPause.h" 1
# 22 "bgPause.h"
...
# 1 "bgLose.h" 1
# 22 "bgLose.h"
extern const unsigned short bgLoseTiles[1728];
...
# 1 "MJWin.h" 1
# 21 "MJWin.h"
extern const unsigned short MJWinBitmap[19200];


extern const unsigned short MJWinPal[256];
# 64 "main.c" 2
...
void initialize() {
 ...
 playSoundA(startBGM, 628416, 11025, 1);
...
void goToStart1() {
 ...
 DMANow(3, bgStart1Pal, ((unsigned short *)0x5000000), 512 / 2);
 DMANow(3, bgStart1Tiles, ((charblock *)0x6000000), 5088 / 2);
 DMANow(3, bgStart1Map, &((screenblock *)0x6000000)[31], 2048 / 2);
 (*(volatile unsigned short*)0x4000008) = (0<<14) | (0<<7) | ((0)<<2) | ((31)<<8);
...
void start1() {
 ...
 if ((!(~(oldButtons)&((1<<0))) && (~buttons & ((1<<0))))) {
  if (cheat == 0) {
   playSoundA(thriller8bit, 1630329, 11025, 1);
  } else {
   playSoundA(cheatBGM, 2537280, 11025, 1);
  }
...
void goToStart2() {
 ...
 DMANow(3, bgStart2Pal, ((unsigned short *)0x5000000), 512 / 2);
 DMANow(3, bgStart2Tiles, ((charblock *)0x6000000), 5216 / 2);
 DMANow(3, bgStart2Map, &((screenblock *)0x6000000)[31], 2048 / 2);
 (*(volatile unsigned short*)0x4000008) = (0<<14) | (0<<7) | ((0)<<2) | ((31)<<8);
...
void goToInst() {
 ...
 hOff = 0;
 vOff = 0;
 DMANow(3, bgInstPal, ((unsigned short *)0x5000000), 512 / 2);
 DMANow(3, bgInstTiles, ((charblock *)0x6000000), 12448 / 2);
 DMANow(3, bgInstMap, &((screenblock *)0x6000000)[31], 2048 / 2);
...
void goToGame() {
 ...
 unpauseSound();
    ...
    DMANow(3, bgGame2Pal, ((unsigned short *)0x5000000), 512 / 2);
 DMANow(3, bgGame2Tiles, &((charblock *)0x6000000)[2], 15040 / 2);
 DMANow(3, bgGame2Map, &((screenblock *)0x6000000)[30], 4096 / 2);
 (*(volatile unsigned short*)0x400000C) = (1<<14) | ((2)<<2) | ((30)<<8);

 DMANow(3, bgGameTiles, &((charblock *)0x6000000)[3], 2528 / 2);
 DMANow(3, bgGameMap, &((screenblock *)0x6000000)[28], 4096 / 2);
...
void game() {
 ...
 if (player.dead) {
  stopSound();
  playSoundA(loseBGM, 85248, 11025, 0);
  goToLose();
 }
}
...
void goToPause() {
 ...
 DMANow(3, bgPauseTiles, ((charblock *)0x6000000), 6656 / 2);
...
void goToWin() {
 ...
 (*(unsigned short *)0x4000000) = 4 | (1<<10);
    DMANow(3, MJWinPal, ((unsigned short *)0x5000000), 256);
    drawFullscreenImage4(MJWinBitmap);

 drawString4(50, 178, "WIN", 255);
 drawString4(160 / 2, 150, "SCORE: ", 255);
 if (score < 0) {
  score = 0;
 }
 sprintf(scoreBuffer, "%d", score);
 if (cheat) {
  drawString4(160 / 2, 150 + 6 * 7, "0", 255);
 } else {
  drawString4(160 / 2, 150 + 6 * 7 , scoreBuffer, 255);
 }
...
void win() {
 if ((!(~(oldButtons)&((1<<3))) && (~buttons & ((1<<3))))) {
  playSoundA(startBGM, 628416, 11025, 0);
  goToStart1();
 }
}
...
void goToLose() {
 ...
 DMANow(3, bgLoseTiles, ((charblock *)0x6000000), 3456 / 2);
